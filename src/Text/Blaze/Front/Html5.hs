...
import Text.Blaze.Front.Svg (Svg)
...
-- > <!DOCTYPE HTML>
--
docType :: Html ev  -- ^ The document type HTML.
...
--
docTypeHtml :: Html ev  -- ^ Inner HTML.
...
--
textarea :: Html ev -> Html ev -- ^ Resulting HTML.
